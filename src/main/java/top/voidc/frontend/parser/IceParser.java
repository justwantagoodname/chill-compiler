...
public class IceParser extends Parser {
	...
	public static final int
		...
		T__73=74, T__74=75, T__75=76, T__76=77, T__77=78, NAME=79, IDENTIFIER=80, 
		GLOBAL_IDENTIFIER=81, NUMBER=82, FLOAT=83, WS=84, LINE_COMMENT=85;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'add'", "'sub'", "'mul'", "'udiv'", "'sdiv'", "'urem'", "'srem'", "'and'", 
			"'or'", "'xor'", "'shl'", "'lshr'", "'ashr'", "'eq'", "'ne'", "'ugt'", 
			"'uge'", "'ult'", "'ule'", "'sgt'", "'sge'", "'slt'", "'sle'", "'oeq'", 
			"'olt'", "'one'", "'oge'", "'ogt'", "'trunc'", "'zext'", "'sext'", "'fptrunc'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, "NAME", "IDENTIFIER", "GLOBAL_IDENTIFIER", 
			"NUMBER", "FLOAT", "WS", "LINE_COMMENT"
		};
	}
	...
	public final ConstantContext constant() throws RecognitionException {
		...
		try {
			...
			setState(321);
			_la = _input.LA(1);
			if ( !(((((_la - 35)) & ~0x3f) == 0 && ((1L << (_la - 35)) & 422212465065999L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final BinOpContext binOp() throws RecognitionException {
		...
		try {
			...
			setState(323);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 4503049871556608L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final CmpOpContext cmpOp() throws RecognitionException {
		...
		try {
			...
			setState(325);
			_la = _input.LA(1);
			if ( !(((((_la - 52)) & ~0x3f) == 0 && ((1L << (_la - 52)) & 32767L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
